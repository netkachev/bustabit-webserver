...
module.exports = {
  ...
  "RECAPTCHA_PRIV_KEY": process.env.RECAPTCHA_PRIV_KEY || '6Lf4pqoUAAAAACL2cuGxba9oaQ7lTFpW-snlh5de',
  "RECAPTCHA_SITE_KEY": process.env.RECAPTCHA_SITE_KEY || '6Lf4pqoUAAAAAI0MkepnZw8IXNjJ1XH4wFq7jaLU',
